...
def screenshot(
    ...
    LLMs like Qwen3.5-VL to understand UI elements and determine next actions.
    ...
    Returns:
        A base64-encoded PNG string. The caller (typically a vision-capable agent)
        will decode and analyze this image to identify clickable elements, text
        fields, buttons, and other UI components.
